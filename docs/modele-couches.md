...
> `bootstrap_base.py` prend tout seul la dernière version publiée (tag ≥ 2.0.0),
> et à défaut la branche `main` du site-base (qui porte le modèle en couches).
> Pour figer une version précise : `python bootstrap_base.py --ref 2.1.0`.
