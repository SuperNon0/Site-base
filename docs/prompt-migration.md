...
> `bootstrap_base.py` récupère tout seul la fondation depuis `main` du site-base
> (ou la dernière version publiée). Pour figer une version : `--ref 2.0.0`.
...
Référence : https://github.com/SuperNon0/Site-base (branche main).
